...
**Book Store** create a single page Bookstore application using Reacts to render a basic UI design/wireframes 
...
1. Clone the repo by running the command
   ```sh
    git clone https://github.com/187jjay187/Book-store.git
   ```
...
Feel free to check the issues page(https://github.com/187jjay187/Book-store/issues).
